...
def main():
    ...
    folder_GT = '/home/pan/work/css/CSS_code/code09_22/temp/test/down_lr/gt'
    folder_Gen = '/home/pan/work/css/CSS_code/code09_22/temp/test/down_lr/finetune'

    crop_border = 4
    suffix = '_sr'  # suffix for Gen images
    ...
    for i, img_path in enumerate(img_list):
        ...
        suffix = '_finetune'
        a = os.path.join(folder_Gen, base_name + suffix + '.png')
